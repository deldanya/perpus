...
st.write("3. Jika peminjam tidak mentaati peraturan dan tata tertib dari perpustakaan PROA Digitalent maka peminjam akan di-blacklist dari perpustakaan ini")